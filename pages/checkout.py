...
# import modules.dynamoDB_component as dynamoDB_component

# dynamoDB_component = dynamoDB_component.Order()
...
def add_orders_to_database():
    ...
    # Add to dynamoDB
    # st.write(order_message)
    respsonse = add_to_database(order_message)

    return_status(vnp_ResponseCode)


add_orders_to_database()
